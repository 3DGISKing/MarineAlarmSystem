...
class APP_EXPORT QgisApp : public QMainWindow, private Ui::MainWindow
{
  ...
  public:
	...
	QAction *actionScaleFeature() { return mActionScaleFeature; } //added by Forest Academy
  ...
  private slots:
	...
	void addLayer(); //added by U Gyong Il 2015 1 17 
    ...
    */
    ...
    class Tools
    {
      public:
		...
		QgsMapTool* mScaleFeature;//added by Forest Academy
