  ...
  public:
    ...
    */
    ...
    QString toProj4() const;
	 ...
	 /** Get an human readable pretty wkt representation of this srs 
	  *  @return string containing pretty Wkt of the srs
	  *  @note  added by U Gyong Il  2015 1 17
     */
    QString toPrettyWkt() const;
