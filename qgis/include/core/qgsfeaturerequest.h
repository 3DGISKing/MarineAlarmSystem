...
class CORE_EXPORT QgsFeatureRequest
{
  public:
	...
	//added by RSH 2015 1 28
	QgsFeatureRequest& setMinimumAreaThreshold(const double area);
	const double       minimumAreaThreshold()const {return mMinimumAreaThreshold;}
	const bool         hasMinimumAreaThreshold()const {return mHasMinimumAreaThreshold;}
	QgsFeatureRequest& setAttributeString(const QString attriStr);
	const QString      attributeString() const { return mAttributeString; }
	//end
  ...
  protected:
	...
	double  mMinimumAreaThreshold;
	bool    mHasMinimumAreaThreshold;
	QString mAttributeString;
};
