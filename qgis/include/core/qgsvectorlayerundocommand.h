...
class CORE_EXPORT QgsVectorLayerUndoCommandTransformFeature : public QgsVectorLayerUndoCommand
{
public:
	QgsVectorLayerUndoCommandTransformFeature( QgsVectorLayerEditBuffer* buffer, QgsFeatureId fid, QgsGeometry* geo, QTransform& trans );
	~QgsVectorLayerUndoCommandTransformFeature();
