...
public:
    ...
    void setupUi(QDockWidget *QgsBrowserDockWidgetBase)
    {
        ...
        QgsBrowserDockWidgetBase->resize(216, 121);
        ...
        mLayoutHeader->setSpacing(5);
        mLayoutHeader->setObjectName(QString::fromUtf8("mLayoutHeader"));
        mLayoutHeader->setContentsMargins(5, -1, 5, -1);
        ...
        mBtnAddLayers->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);
        ...
        mBtnFilter = new QToolButton(frame);
        mBtnFilter->setObjectName(QString::fromUtf8("mBtnFilter"));
        mBtnFilter->setMaximumSize(QSize(16777215, 16777215));
        mBtnFilter->setIcon(icon2);
        mBtnFilter->setAutoRaise(true);

        horizontalLayout_3->addWidget(mBtnFilter);
        ...
        mLeFilter->setMaximumSize(QSize(200, 16777215));
        ...
        horizontalSpacer_3 = new QSpacerItem(0, 20, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);
...
#endif // QT_NO_TOOLTIP
        mBtnAddLayers->setText(QApplication::translate("QgsBrowserDockWidgetBase", "Add", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mBtnFilter->setToolTip(QApplication::translate("QgsBrowserDockWidgetBase", "Filter files", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mBtnFilter->setText(QString());
    } // retranslateUi
