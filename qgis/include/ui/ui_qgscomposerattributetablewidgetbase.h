...
public:
    ...
    void setupUi(QWidget *QgsComposerAttributeTableWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -400, 392, 1192));
        ...
        mMaximumRowsSpinBox = new QSpinBox(groupBox_5);
        ...
        mMarginSpinBox = new QDoubleSpinBox(groupBox_6);
        ...
        QWidget::setTabOrder(mBackgroundColorButton, mShowGridGroupCheckBox);
    ...
    void retranslateUi(QWidget *QgsComposerAttributeTableWidgetBase)
    {
        ...
        mGridStrokeWidthLabel->setText(QApplication::translate("QgsComposerAttributeTableWidgetBase", "Stroke width", 0, QApplication::UnicodeUTF8));
