...
public:
    ...
    void setupUi(QMainWindow *QgsComposerBase)
    {
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/themes/default/mActionAddMap.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images/themes/default/mActionLabel.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/images/themes/default/mActionAddLegend.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/images/themes/default/mActionScaleBar.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/images/themes/default/mActionAddImage.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon23;
        icon23.addFile(QString::fromUtf8(":/images/themes/default/mActionInvertSelection.png"), QSize(), QIcon::Normal, QIcon::Off);
        mActionInvertSelection->setIcon(icon23);
        ...
        QIcon icon24;
        icon24.addFile(QString::fromUtf8(":/images/themes/default/mActionOptions.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mActionOptions->setIcon(icon24);
        ...
        QIcon icon25;
        icon25.addFile(QString::fromUtf8(":/images/themes/default/mActionAtlasFirst.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mActionAtlasFirst->setIcon(icon25);
        mActionAtlasPrev = new QAction(QgsComposerBase);
        mActionAtlasPrev->setObjectName(QString::fromUtf8("mActionAtlasPrev"));
        QIcon icon26;
        icon26.addFile(QString::fromUtf8(":/images/themes/default/mActionAtlasPrev.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mActionAtlasPrev->setIcon(icon26);
        mActionAtlasNext = new QAction(QgsComposerBase);
        mActionAtlasNext->setObjectName(QString::fromUtf8("mActionAtlasNext"));
        QIcon icon27;
        icon27.addFile(QString::fromUtf8(":/images/themes/default/mActionAtlasNext.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mActionAtlasNext->setIcon(icon27);
        mActionAtlasLast = new QAction(QgsComposerBase);
        mActionAtlasLast->setObjectName(QString::fromUtf8("mActionAtlasLast"));
        QIcon icon28;
        icon28.addFile(QString::fromUtf8(":/images/themes/default/mActionAtlasLast.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mActionAtlasLast->setIcon(icon28);
        mActionAtlasPreview = new QAction(QgsComposerBase);
        mActionAtlasPreview->setObjectName(QString::fromUtf8("mActionAtlasPreview"));
        QIcon icon29;
        icon29.addFile(QString::fromUtf8(":/images/themes/default/mIconAtlas.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mActionAtlasPreview->setIcon(icon29);
        ...
        QIcon icon30;
        icon30.addFile(QString::fromUtf8(":/images/themes/default/mActionAtlasSettings.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mActionAtlasSettings->setIcon(icon30);
    ...
    void retranslateUi(QMainWindow *QgsComposerBase)
    {
        ...
        mPaperNavToolbar->setWindowTitle(QApplication::translate("QgsComposerBase", "Paper Navigation", 0, QApplication::UnicodeUTF8));
        mItemActionToolbar->setWindowTitle(QApplication::translate("QgsComposerBase", "Composer Item Actions", 0, QApplication::UnicodeUTF8));
        mItemToolbar->setWindowTitle(QApplication::translate("QgsComposerBase", "Composer Items", 0, QApplication::UnicodeUTF8));
