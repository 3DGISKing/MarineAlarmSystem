...
public:
    ...
    QDoubleSpinBox *mMaxDistanceSpinBox;
    ...
    void setupUi(QWidget *QgsComposerHtmlWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -157, 391, 517));
        ...
        mMaxDistanceSpinBox = new QDoubleSpinBox(mUseSmartBreaksCheckBox);
