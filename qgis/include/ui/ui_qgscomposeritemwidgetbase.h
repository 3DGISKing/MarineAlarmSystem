...
public:
    ...
    QSpinBox *mPageSpinBox;
    QDoubleSpinBox *mWidthSpin;
    QDoubleSpinBox *mHeightSpin;
    QDoubleSpinBox *mYPosSpin;
    QDoubleSpinBox *mXPosSpin;
    ...
    QDoubleSpinBox *mItemRotationSpinBox;
    ...
    void setupUi(QWidget *QgsComposerItemWidgetBase)
    {
        ...
        mPageSpinBox = new QSpinBox(mGeneralOptionsGroupBox);
        ...
        mWidthSpin = new QDoubleSpinBox(mGeneralOptionsGroupBox);
        ...
        mHeightSpin = new QDoubleSpinBox(mGeneralOptionsGroupBox);
        ...
        mYPosSpin = new QDoubleSpinBox(mGeneralOptionsGroupBox);
        ...
        mXPosSpin = new QDoubleSpinBox(mGeneralOptionsGroupBox);
        ...
        mItemRotationSpinBox = new QDoubleSpinBox(mTransformsGroupBox);
        ...
        mOutlineWidthSpinBox = new QDoubleSpinBox(mFrameGroupBox);
        ...
        mTransparencySpnBx = new QSpinBox(groupRendering);
