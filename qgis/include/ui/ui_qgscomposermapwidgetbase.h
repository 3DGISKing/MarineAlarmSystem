...
public:
    ...
    QDoubleSpinBox *mMapRotationSpinBox;
    ...
    QDoubleSpinBox *mGridFramePenSizeSpinBox;
    ...
    void setupUi(QWidget *QgsComposerMapWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -1149, 444, 2196));
        ...
        mMapRotationSpinBox = new QDoubleSpinBox(groupBox);
        ...
        gridLayout_5->addWidget(mDrawCanvasItemsCheckBox, 3, 0, 1, 2);
        ...
        gridLayout_5->addLayout(horizontalLayout_10, 4, 0, 1, 2);
        ...
        mAtlasMarginSpinBox = new QSpinBox(mAtlasCheckBox);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/themes/default/mActionArrowUp.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/themes/default/mActionArrowDown.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mGridFramePenSizeSpinBox = new QDoubleSpinBox(mGridFrameGroupBox);
        ...
        gridLayout_3->addLayout(gridLayout_4, 4, 0, 1, 3);
        ...
        mFrameWidthSpinBox = new QDoubleSpinBox(mGridFrameGroupBox);
        ...
        gridLayout_7->addWidget(mAnnotationFormatComboBox, 0, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationPositionLeftComboBox, 1, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationDirectionComboBoxLeft, 2, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationPositionLabelRight, 3, 0, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationPositionRightComboBox, 3, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationDirectionComboBoxRight, 4, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationPositionLabelTop, 5, 0, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationPositionTopComboBox, 5, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationDirectionComboBoxTop, 6, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationPositionLabelBottom, 7, 0, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationPositionBottomComboBox, 7, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationDirectionComboBoxBottom, 8, 1, 1, 1);

        label = new QLabel(mDrawAnnotationGroupBox);
        label->setObjectName(QString::fromUtf8("label"));

        gridLayout_7->addWidget(label, 9, 0, 1, 1);
        ...
        gridLayout_7->addWidget(mAnnotationFontColorButton, 10, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mDistanceToFrameLabel, 11, 0, 1, 1);

        mDistanceToMapFrameSpinBox = new QDoubleSpinBox(mDrawAnnotationGroupBox);
        mDistanceToMapFrameSpinBox->setObjectName(QString::fromUtf8("mDistanceToMapFrameSpinBox"));

        gridLayout_7->addWidget(mDistanceToMapFrameSpinBox, 11, 1, 1, 1);
        ...
        gridLayout_7->addWidget(mCoordinatePrecisionLabel, 12, 0, 1, 1);

        mCoordinatePrecisionSpinBox = new QSpinBox(mDrawAnnotationGroupBox);
        mCoordinatePrecisionSpinBox->setObjectName(QString::fromUtf8("mCoordinatePrecisionSpinBox"));

        gridLayout_7->addWidget(mCoordinatePrecisionSpinBox, 12, 1, 1, 1);
        ...
        QWidget::setTabOrder(mLayerListFromPresetButton, mExtentsCheckBox);
        ...
        QWidget::setTabOrder(mAnnotationFormatComboBox, mAnnotationPositionLeftComboBox);
