...
public:
    ...
    void setupUi(QWidget *QgsComposerTableWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -139, 392, 711));
    ...
    void retranslateUi(QWidget *QgsComposerTableWidgetBase)
    {
        ...
        mGridStrokeWidthLabel->setText(QApplication::translate("QgsComposerTableWidgetBase", "Stroke width", 0, QApplication::UnicodeUTF8));
