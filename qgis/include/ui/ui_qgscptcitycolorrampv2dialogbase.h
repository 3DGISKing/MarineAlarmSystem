/********************************************************************************
** Form generated from reading UI file 'qgscptcitycolorrampv2dialogbase.ui'
**
...
#ifndef UI_QGSCPTCITYCOLORRAMPV2DIALOGBASE_H
#define UI_QGSCPTCITYCOLORRAMPV2DIALOGBASE_H
...
class Ui_QgsCptCityColorRampV2DialogBase
{
public:
    ...
    void setupUi(QDialog *QgsCptCityColorRampV2DialogBase)
    {
        if (QgsCptCityColorRampV2DialogBase->objectName().isEmpty())
            QgsCptCityColorRampV2DialogBase->setObjectName(QString::fromUtf8("QgsCptCityColorRampV2DialogBase"));
        QgsCptCityColorRampV2DialogBase->resize(800, 580);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(1);
        sizePolicy.setHeightForWidth(QgsCptCityColorRampV2DialogBase->sizePolicy().hasHeightForWidth());
        QgsCptCityColorRampV2DialogBase->setSizePolicy(sizePolicy);
        verticalLayout_4 = new QVBoxLayout(QgsCptCityColorRampV2DialogBase);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        verticalLayout_4->setSizeConstraint(QLayout::SetMinimumSize);
        tabBar = new QTabBar(QgsCptCityColorRampV2DialogBase);
        tabBar->setObjectName(QString::fromUtf8("tabBar"));

        verticalLayout_4->addWidget(tabBar);

        mStackedWidget = new QStackedWidget(QgsCptCityColorRampV2DialogBase);
        ...
        cboConvertStandard = new QCheckBox(QgsCptCityColorRampV2DialogBase);
        ...
        buttonBox = new QDialogButtonBox(QgsCptCityColorRampV2DialogBase);
        ...
        retranslateUi(QgsCptCityColorRampV2DialogBase);
        QObject::connect(buttonBox, SIGNAL(accepted()), QgsCptCityColorRampV2DialogBase, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), QgsCptCityColorRampV2DialogBase, SLOT(reject()));

        mStackedWidget->setCurrentIndex(0);
        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(QgsCptCityColorRampV2DialogBase);
    } // setupUi

    void retranslateUi(QDialog *QgsCptCityColorRampV2DialogBase)
    {
        QgsCptCityColorRampV2DialogBase->setWindowTitle(QApplication::translate("QgsCptCityColorRampV2DialogBase", "cpt-city color ramp", 0, QApplication::UnicodeUTF8));
        lblCollectionInfo->setText(QString());
        label->setText(QApplication::translate("QgsCptCityColorRampV2DialogBase", "License", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("QgsCptCityColorRampV2DialogBase", "Palette", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("QgsCptCityColorRampV2DialogBase", "Path", 0, QApplication::UnicodeUTF8));
        lblPreview->setText(QString());
        lblSchemeName->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("QgsCptCityColorRampV2DialogBase", "Selection and preview", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("QgsCptCityColorRampV2DialogBase", "Author(s)", 0, QApplication::UnicodeUTF8));
        lblAuthorName->setText(QString());
        label_3->setText(QApplication::translate("QgsCptCityColorRampV2DialogBase", "Source", 0, QApplication::UnicodeUTF8));
        lblSrcLink->setText(QString());
        label_5->setText(QApplication::translate("QgsCptCityColorRampV2DialogBase", "License", 0, QApplication::UnicodeUTF8));
        pbtnLicenseDetails->setText(QApplication::translate("QgsCptCityColorRampV2DialogBase", "Details", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("QgsCptCityColorRampV2DialogBase", "Information", 0, QApplication::UnicodeUTF8));
        cboConvertStandard->setText(QApplication::translate("QgsCptCityColorRampV2DialogBase", "Save as standard gradient", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class QgsCptCityColorRampV2DialogBase: public Ui_QgsCptCityColorRampV2DialogBase {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_QGSCPTCITYCOLORRAMPV2DIALOGBASE_H
