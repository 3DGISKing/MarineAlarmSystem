...
public:
    ...
    void setupUi(QDialog *QgsSymbolV2SelectorDialogBase)
    {
        ...
        QgsSymbolV2SelectorDialogBase->resize(436, 359);
        ...
        btnSaveSymbol = new QPushButton(QgsSymbolV2SelectorDialogBase);
        btnSaveSymbol->setObjectName(QString::fromUtf8("btnSaveSymbol"));
        btnSaveSymbol->setMaximumSize(QSize(70, 16777215));

        pushBtnBox->addWidget(btnSaveSymbol);
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        btnSaveSymbol->setToolTip(QApplication::translate("QgsSymbolV2SelectorDialogBase", "Save symbol", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        btnSaveSymbol->setText(QApplication::translate("QgsSymbolV2SelectorDialogBase", "Save", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
