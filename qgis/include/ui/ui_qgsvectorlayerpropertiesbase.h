...
public:
    ...
    void setupUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 730, 502));
        ...
        groupBox->setSyncGroup(QString::fromUtf8("vectorgeneral"));
        ...
        indexGroupBox->setSyncGroup(QString::fromUtf8("vectorgeneral"));
        ...
        leSpatialRefSys->setMinimumSize(QSize(100, 0));
        leSpatialRefSys->setReadOnly(true);

        horizontalLayout_3->addWidget(leSpatialRefSys);
        ...
        horizontalLayout_3->addWidget(pbnChangeSpatialRefSys);
        ...
        scrollAreaWidgetContents_9->setGeometry(QRect(0, 0, 121, 38));
        ...
        scrollAreaWidgetContents_19->setGeometry(QRect(0, 0, 702, 171));
        ...
        scrollAreaWidgetContents_10->setGeometry(QRect(0, 0, 476, 182));
        ...
        fieldComboBox = new QComboBox(groupBox_2);
        ...
        displayFieldComboBox = new QComboBox(groupBox_2);
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 90, 113));
        ...
        mJoinTreeWidget->setColumnCount(4);
        ...
        mButtonRemoveJoin->setIcon(icon13);
        ...
        scrollArea_8 = new QScrollArea(mOptsPage_Diagrams);
        ...
        scrollAreaWidgetContents_8->setGeometry(QRect(0, 0, 100, 30));
        verticalLayout_24 = new QVBoxLayout(scrollAreaWidgetContents_8);
        verticalLayout_24->setContentsMargins(0, 0, 0, 0);
        verticalLayout_24->setObjectName(QString::fromUtf8("verticalLayout_24"));
        mDiagramFrame = new QFrame(scrollAreaWidgetContents_8);
        ...
        verticalLayout_24->addWidget(mDiagramFrame);
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 393, 608));
        ...
        mMetaMetaUrlGrpBx->setSyncGroup(QString::fromUtf8("vectormeta"));
        ...
        mMetaPropertiesGrpBx->setSyncGroup(QString::fromUtf8("vectormeta"));
        ...
        pbnLoadStyle = new QPushButton(mOptionsFrame);
        pbnLoadStyle->setObjectName(QString::fromUtf8("pbnLoadStyle"));

        horizontalLayout_9->addWidget(pbnLoadStyle);

        pbnSaveDefaultStyle = new QPushButton(mOptionsFrame);
        pbnSaveDefaultStyle->setObjectName(QString::fromUtf8("pbnSaveDefaultStyle"));

        horizontalLayout_9->addWidget(pbnSaveDefaultStyle);

        pbnLoadDefaultStyle = new QPushButton(mOptionsFrame);
        pbnLoadDefaultStyle->setObjectName(QString::fromUtf8("pbnLoadDefaultStyle"));

        horizontalLayout_9->addWidget(pbnLoadDefaultStyle);

        pbnSaveStyleAs = new QPushButton(mOptionsFrame);
        pbnSaveStyleAs->setObjectName(QString::fromUtf8("pbnSaveStyleAs"));

        horizontalLayout_9->addWidget(pbnSaveStyleAs);
    ...
    void retranslateUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        pbnChangeSpatialRefSys->setText(QApplication::translate("QgsVectorLayerPropertiesBase", "Specify...", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        mScaleRangeWidget->setToolTip(QApplication::translate("QgsVectorLayerPropertiesBase", "A widget to define the scale visibility", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        mScaleRangeWidget->setWhatsThis(QApplication::translate("QgsVectorLayerPropertiesBase", "A widget to define the scale visibility.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_WHATSTHIS
        mSubsetGroupBox->setTitle(QApplication::translate("QgsVectorLayerPropertiesBase", "Feature subset", 0, QApplication::UnicodeUTF8));
